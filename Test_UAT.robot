# 663380019-2 นายปวริศ กุลแก้ว sec.1

*** Settings ***
Library    SeleniumLibrary

*** Variables ***
${CHROME_BROWSER_PATH}     D:/QA/ChromeForTesting/chrome-win64/chrome-win64/chrome.exe
${CHROME_DRIVER_PATH}      D:/QA/ChromeForTesting/chromedriver-win64/chromedriver-win64/chromedriver.exe
${REG_URL}                 http://127.0.0.1:5500/Lab10/Registration.html
